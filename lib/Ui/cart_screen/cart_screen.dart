          ...
          children: [
            ...
            Padding(
              ...
              child: Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  baseText(title: "Total", color:AppColor.darkTextColor , size: 26.0),
                  baseText(title: "\$ 200", color: AppColor.darkYellow, size:26.0 ),
              ...
              child: FlatButton(
                ...
                onPressed: () {
                  Navigator.push(context, MaterialPageRoute(
                    builder: (context)=> CheckoutAddress(ticks: 1,)
                  ));
                },
                child: Text(
                  'Check Out',
