...
class _$ClearGlobal extends ClearGlobal {
  factory _$ClearGlobal([void Function(ClearGlobalBuilder) updates]) =>
      (new ClearGlobalBuilder()..update(updates)).build();

  _$ClearGlobal._() : super._();

  @override
  ClearGlobal rebuild(void Function(ClearGlobalBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  ClearGlobalBuilder toBuilder() => new ClearGlobalBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is ClearGlobal;
  }
  ...
  @override
  String toString() {
    return newBuiltValueToStringHelper('ClearGlobal').toString();
  }
}

class ClearGlobalBuilder implements Builder<ClearGlobal, ClearGlobalBuilder> {
  _$ClearGlobal _$v;

  ClearGlobalBuilder();

  @override
  void replace(ClearGlobal other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$ClearGlobal;
  }

  @override
  void update(void Function(ClearGlobalBuilder) updates) {
    if (updates != null) updates(this);
  }

  @override
  _$ClearGlobal build() {
    final _$result = _$v ?? new _$ClearGlobal._();
    replace(_$result);
    return _$result;
  }
}
