                    ...
                    Center(
                      child: Directionality(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            SizedBox(height: 16),
                            state.sliders.isEmpty?Container(height: 210,):
                            SizedBox(
                              // color: Colors.red,
                              height: 210,
                              // width: 100,
                                ...
                                children: List.generate(
                                    3,
                                        ...
                                        Container(
                                          ...
                                          child: Image.network(
                                            BaseImgUrl+state.sliders[index].img,
                                            fit: BoxFit.fill,
                                          ),
                                        )
                              ...
                              child: Container(
                                child: SmoothPageIndicator(
                                  ...
                                  effect: ExpandingDotsEffect(
                                    ...
                                    dotColor: AppColor.darkYellow.withOpacity(0.5),
                                    expansionFactor: 4,
                                    dotHeight: 8,
                                    dotWidth: 8,
                                  ),
                            ...
                            ///ocasions
                            state.occasions.isEmpty?Container(
                              height: 120,
                            ):
                            Padding(
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: Text(
                                      "Occasions",
                                      style: TextStyle(
                                          color: Color(0xff393741), fontSize: 18),
                                    ),
                                  ),
                                  Container(
                                    height: 120,
                                          ...
                                          child: GestureDetector(
                                            onTap: (){
                                              Navigator.push(context, MaterialPageRoute(
                                                  builder: (context)=> AllProductsScreen(id: state.occasions[index].id , type: "occasion",)
                                              ));
                                            },
                            ...
                            ///near occasions
                            state.nearbyOccasions.isEmpty?Container():
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                      ...
                                      children: [
                                        Padding(
                                            ...
                                            child: GestureDetector(
                                              onTap: (){
                                                Navigator.push(context, MaterialPageRoute(
                                                    builder: (context)=> AllProductsScreen(id: state.nearbyOccasions[0].id , type: "occasion",)
                                                ));
                                              },
                                              child: Stack(
                                                children: [
                                                  ...
                                                  Container(
                                                    ...
                                                    child: Image.network(BaseImgUrl+state.nearbyOccasions[0].image),
                                                  ),
                                                  // Positioned(
                                                  //     right: 40,
                                                  //     bottom: 4,
                                        ...
                                        GestureDetector(
                                          onTap: (){
                                            Navigator.push(context, MaterialPageRoute(
                                                builder: (context)=> AllProductsScreen(id: state.nearbyOccasions[1].id , type: "occasion",)
                                            ));
                                          },
                                          child: Stack(
                                            children: [
                                              ...
                                              Container(
                                                ...
                                                child: Image.network(BaseImgUrl+state.nearbyOccasions[1].image),
                                              ),
                                  ...
                                  GestureDetector(
                                    onTap: (){
                                      Navigator.push(context, MaterialPageRoute(
                                          builder: (context)=> AllProductsScreen(id: state.nearbyOccasions[2].id , type: "occasion",)
                                      ));
                                    },
                                    child: Container(
                                      height: 280,
                                      ...
                                      child: Column(
                                        children: [
                                          ...
                                          Container(
                                            child: Text(
                                              state.nearbyOccasions[2].enName,
                                              style: TextStyle(
                                                fontSize: 22,
                                                color: Color(0xff393741),
                                              ),
                                          ...
                                          Container(
                                              ...
                                              width: 140,
                                              child: Image.network(
                                                BaseImgUrl+state.nearbyOccasions[2].image,
                                                fit: BoxFit.fill,
                                              )),
                                          SizedBox(
                                            height: 25,
                              ...
                              child: Row(
                                ...
                                children: [
                                  Text(
                                    "Top Seller",
                                    style: TextStyle(
                                        fontSize: 22, color: Color(0xff393741)),
                                  ),
                                  GestureDetector(
                                    onTap: (){
                                      Navigator.push(context, MaterialPageRoute(
                                        builder: (context)=>AllProductsScreen(id:1, type:'all')
                                      ));
                                    },
                                    child: Text(
                                      "More",
                                      style: TextStyle(
                                          color: AppColor.darkYellow, fontSize: 18),
                                    ),
                                  )
                                ],
                              ),
                            ...
                            state.products.isEmpty?Container():
                            Padding(
                                  ...
                                  child: Stack(
                                    children: [
                                      Container(
                                          ...
                                          //  color: Colors.green,
                                          child: Image.network(
                                            BaseImgUrl+state.products[9].image,
                                            fit: BoxFit.cover,
                                          )),
                                    ],
                                  ),
                                    ...
                                    children: [
                                      Padding(
                                        ...
                                        child: Text(
                                          ...
                                          style: TextStyle(
                                              fontSize: 26, color: Color(0xff393741)),
                                        ),
                                      ),
                                      Text(
                                        "Lorem ipsum is placeholder\ntext commonly used in the\ngraphic.",
                                        style: TextStyle(
                                            fontSize: 16, color: Color(0xff393741)),
                                      ),
                                      Padding(
                            ...
                            ///Categories
                            state.categories.isEmpty?Container(
                              height: 120,
                            ):
                            Padding(
                                      ...
                                      itemBuilder: (BuildContext context, int index) {
                                        return Padding(
                                          ...
                                          child: GestureDetector(
                                            onTap: (){
                                              Navigator.push(context, MaterialPageRoute(
                                                  builder: (context)=> AllProductsScreen(id: state.brands[index].id , type: "category",)
                                              ));
                                            },
                                            child: singleCategory(
                                                title: state.categories[index].enName,
                                          ...
                                          child: Column(
                                            children: [
                                              GestureDetector(
                                                onTap:(){
                                                  Navigator.push(context, MaterialPageRoute(
                                                      builder: (context)=>ProductScreen(id: 4,)
                                                  ));
                                                },
                                                child: Container(
                                                  width: size.width*0.4,
                                                    ...
                                                    children: [
                                                      Padding(
                                                        ...
                                                        child: Container(
                                                            ...
                                                            child: ClipRRect(
                                                              ...
                                                              BorderRadius.all(Radius.circular(12)),
                                                              child: Image.network(
                                                                BaseImgUrl+state.products[0].image,
                                                                fit: BoxFit.fill,
                                                              ),
                                                            )),
                                                      ),
                                                      ...
                                                      Padding(
                                                        ...
                                                        child: Row(
                                                          ...
                                                          children: [
                                                            Text(
                                                              state.products[0].nameEn,
                                                              style: TextStyle(
                                                                  color: Color(0xff393741),
                                                                  fontSize: 18),
                                                            ),
                                                            Text(
                                                              state.products[0].mainPrice + "\$",
                                                              style: TextStyle(
                                                                  color: AppColor.darkYellow,
                                                                  fontSize: 15),
                                                            )
                                                    ...
                                                    children: [
                                                      Padding(
                                                        ...
                                                        child: Container(
                                                            ...
                                                            child: ClipRRect(
                                                              ...
                                                              BorderRadius.all(Radius.circular(12)),
                                                              child: Image.network(
                                                                BaseImgUrl+state.products[1].image,
                                                                fit: BoxFit.fill,
                                                              ),
                                                            )),
                                                      ),
                                                      ...
                                                      Padding(
                                                        ...
                                                        child: Row(
                                                          ...
                                                          children: [
                                                            Text(
                                                              state.products[1].nameEn,
                                                              style: TextStyle(
                                                                  color: Color(0xff393741),
                                                                  fontSize: 18),
                                                            ),
                                                            Text(
                                                              state.products[1].mainPrice + "\$",
                                                              style: TextStyle(
                                                                  color: AppColor.darkYellow,
                                                                  fontSize: 15),
                                                            )
                                                    ...
                                                    children: [
                                                      Padding(
                                                        ...
                                                        child: Container(
                                                            ...
                                                            child: ClipRRect(
                                                              ...
                                                              BorderRadius.all(Radius.circular(12)),
                                                              child: Image.network(
                                                                BaseImgUrl+state.products[2].image,
                                                                fit: BoxFit.fill,
                                                              ),
                                                            )),
                                                      ),
                                                      ...
                                                      Padding(
                                                        ...
                                                        child: Row(
                                                          ...
                                                          children: [
                                                            Text(
                                                              state.products[2].nameEn,
                                                              style: TextStyle(
                                                                  color: Color(0xff393741),
                                                                  fontSize: 18),
                                                            ),
                                                            Text(
                                                              state.products[2].mainPrice + "\$",
                                                              style: TextStyle(
                                                                  color: AppColor.darkYellow,
                                                                  fontSize: 15),
                                                            )
                                                    ...
                                                    children: [
                                                      Padding(
                                                        ...
                                                        child: Container(
                                                            ...
                                                            child: ClipRRect(
                                                              ...
                                                              BorderRadius.all(Radius.circular(12)),
                                                              child: Image.network(
                                                                BaseImgUrl+state.products[3].image,
                                                                fit: BoxFit.fill,
                                                              ),
                                                            )),
                                                      ),
                                                      ...
                                                      Padding(
                                                        ...
                                                        child: Row(
                                                          ...
                                                          children: [
                                                            Text(
                                                              state.products[3].nameEn,
                                                              style: TextStyle(
                                                                  color: Color(0xff393741),
                                                                  fontSize: 18),
                                                            ),
                                                            Text(
                                                              state.products[3].mainPrice + "\$",
                                                              style: TextStyle(
                                                                  color: AppColor.darkYellow,
                                                                  fontSize: 15),
                                                            )
                            ...
                            ///brands
                            if (state.brands.isEmpty) Container(height: 70,) else Padding(
                                 ...
                                 itemBuilder: (BuildContext context , int index){
                                    return Padding(
                                      ...
                                      child: GestureDetector(
                                        onTap: (){
                                          Navigator.push(context, MaterialPageRoute(
                                            builder: (context)=> AllProductsScreen(id: state.brands[index].id , type: "brand",)
                                          ));
                                        },
                                        child: Container(
                                          width: 150,
                                          ...
                                          child:
                                           ClipRRect(
                                             borderRadius: BorderRadius.all(Radius.circular(12)),
                                               child: Image.network(BaseImgUrl+state.brands[index].image,fit: BoxFit.fill,)),
                                        ),
                                      ),
                                    );
                                 },
                                ...
                                child: Column(
                                  ...
                                  children: [
                                            ...
                                            itemBuilder: (BuildContext context, int index){
                                              return Padding(
                                                ...
                                                child: GestureDetector(
                                                  ...
                                                  child: Column(
                                                    children: [
                                                      Text(state.wraps[index].wrapNameEn , style: TextStyle(color:index == wrapIndex?AppColor.darkYellow: Color(0xff393741),fontSize:18 ),),
                                                      wrapIndex == index
                                                          ?
                                                      Container(
                                                        width: 10,
                                    ...
                                    Container(
                                      ...
                                      child: ListView.builder(
                                        scrollDirection: Axis.horizontal,
                                        itemCount: state.wraps[wrapIndex].wrapItems.length,
                                          itemBuilder: (BuildContext context , int index){
                                              return  Padding(
                                                padding: const EdgeInsets.symmetric(horizontal:8.0),
                                                child: Container(
                                                            ...
                                                            children: [
                                                              Padding(
                                                                ...
                                                                child: Container(
                                                                    width:122,
                                                                    height:100 ,
                                                                    child: Image.network(BaseImgUrl+state.wraps[wrapIndex].wrapItems[index].image,
                                                                      fit: BoxFit.fill,)),
                                                              ),
                                                              Text(state.wraps[wrapIndex].wrapItems[index].mainPrice+"\$",style: TextStyle(
                                                                  color: Colors.white,
                                                                  fontSize: 24,
                                                                  fontWeight: FontWeight.bold
                                                              ),)
                            ...
                            state.coupons.isEmpty?Container(height: 30,):
                            Padding(
                              padding: const EdgeInsets.symmetric(horizontal: 16.0),
                              child: Row(
                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            ...
                            state.coupons.isEmpty?Container(height: 200,):
                            Padding(
                              padding: const EdgeInsets.symmetric(vertical: 10.0 , ),
                              child: Container(
                                height: 200,
                                                    ...
                                                    child: Container(
                                                      ...
                                                      decoration: BoxDecoration(
                                                        ...
                                                        image: DecorationImage(
                                                          fit: BoxFit.fill,
                                                          image: NetworkImage(BaseImgUrl+state.coupons[index].image),
                                                        ),
                                                      ),
                                                    ),
                                                  ),
    ...
    children: [
      Container(
        ...
        child: Padding(
          ...
          child: Image.network(BaseImgUrl+image,fit: BoxFit.fill,),
        ),
      ),
      SizedBox(
        height: 8,
  ...
  return Padding(
    ...
    child: Container(
        ...
        decoration: BoxDecoration(
            // color: Colors.green,
            image: DecorationImage(
                image: AssetImage(slider[itemIndex]),
                fit: BoxFit.fill
            )
        )
    ),
